...
const PublicProfilePage = () => {
  ...
  if (error) {
    return (
      <Container maxWidth="lg" sx={{ mt: 4, minHeight: '80vh', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        ...
        <Box sx={{ display: 'flex', gap: 2, justifyContent: 'center' }}>
          ...
          <Button variant="outlined" onClick={handleRetry} sx={{ px: 4 }}>
            Try Again
          </Button>
        </Box>
      </Container>
