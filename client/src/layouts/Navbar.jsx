            ...
            {loggedIn ? (
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                ...
                <IconButton edge="end" aria-controls="menu-appbar" aria-haspopup="true" onClick={handleMenuOpen} color="inherit">
                  <Avatar src={userImage} alt={`${userFirstName} ${userLastName}`} />
                </IconButton>
                <Menu id="menu-appbar" anchorEl={anchorEl} open={isMenuOpen} onClose={handleMenuClose}>
                  <MenuItem>{`Hello, ${userFirstName} ${userLastName}`}</MenuItem>
                  <MenuItem component={Link} to="/profile/private">
      ...
      <Drawer anchor="left" open={drawerOpen} onClose={toggleDrawer(false)}>
        <Box sx={{ width: 250 }} role="presentation" onClick={toggleDrawer(false)} onKeyDown={toggleDrawer(false)}>
          <List>
            ...
            {loggedIn && (
              <ListItem component={Link} to="/profile/private">
                <ListItemIcon>
