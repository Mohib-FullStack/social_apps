...
//   max: 100, // Increased general limit
//   standardHeaders: true,
//   legacyHeaders: false,
//   message: {
//     success: false,
...
// app.use("/api/auth", authRateLimiter); // Stricter limits for auth routes
// app.use(generalRateLimiter); // General limit for all other routes
...
// app.use("/api/auth", authRouter);
// app.use("/api/users", userRouter);
// app.use('/api', phoneRouter); // Now uses completely isolated middleware
// app.use("/api/coverImage", coverImageRouter);
