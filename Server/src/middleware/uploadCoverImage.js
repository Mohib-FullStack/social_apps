...
// Export both the instance and configured middlewares
module.exports = {
  uploadCoverImage, // the raw multer instance
  singleCoverImage: uploadCoverImage.single('coverImage'), // for single file
  arrayCoverImages: uploadCoverImage.array('coverImages', 5) // for multiple files
};
